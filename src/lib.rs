...
pub struct ParseStrDateTimeError;
...
impl StrDateTime {
    ...
    fn distance_between(self, second: StrDateTime) -> Distance {
        ...
        Distance::new(
            (date2 - date1).num_seconds(),
            Self::num_sundays(date1, date2),
            Self::num_saturdays(date1, date2),
        )
    }
...
mod tests {
    ...
    fn add_distance() {
        ...
        assert_eq!(
            date.add_seconds(86400),
            StrDateTime::new(2023, 01, 13, 0, 0, 0)
        );
        assert_eq!(
            date.add_minutes(10),
            StrDateTime::new(2023, 01, 12, 0, 10, 0)
        );
